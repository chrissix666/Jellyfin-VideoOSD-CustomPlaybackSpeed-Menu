...
**Customizes the Jellyfin Web VideoOSD playback speed menu.**<br> 
...
Note:<br>
During testing, values below `0.1x` could cause problems when switching back to very high speeds afterwards.<br>
